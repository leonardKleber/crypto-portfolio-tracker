"""
This file contains all functions used to retrieve data from the
CoinGecko API required for the app. Besides converting timestamps from
UNIX to ISO format, the data remains untransformed.
"""
import os
import requests
...
"""
This function converts timestamps in CoinGecko API price data from UNIX
time to ISO format. The data is received in the form: 
        
    [[timestamp, price], [timestamp, price], ...]
"""
def convert_price_data_to_iso(prices):
    prices_iso = [
        [dt.utcfromtimestamp(ts / 1000).isoformat(), price]
...
"""
Retrieves one year of historical price data for a specific coin from
the CoinGecko API.

Note: The free CoinGecko plan only allows access to up to 365 days of
historical data.
"""
...
"""
Retrieves price data from the CoinGecko API over the last 24 hours in
5-minute intervals.
"""
